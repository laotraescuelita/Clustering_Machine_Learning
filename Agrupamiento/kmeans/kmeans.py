...
kmeans.fit(matriz)
kmeans_etiquetas = kmeans.labels_
print("Etiquetas :\n{}".format(kmeans_etiquetas))
print("Dimensiones :\n{}".format(kmeans_etiquetas.shape))
#Unir el vector de clasificacion con la matriz de datos.
#Primero hay que covertir el vector a dataframe.
kmeans_etiquetas_ = pd.DataFrame( kmeans_etiquetas, columns= ["Categorias"])
matriz_kmeans = pd.merge(matriz, kmeans_etiquetas_, left_index= True, right_index= True, how = "inner")
print("\nMatriz con las categorias asignadas por kmeans: \n ", matriz_kmeans.head(2) )
print("\nTipos de variables de la nueva matriz con las categorias de kmeans: \n ", matriz_kmeans.info())

#Exportar los datos.
matriz_kmeans.to_csv("matriz_kmeans.csv")

plt.scatter(matriz_kmeans.iloc[:, 0], matriz_kmeans.iloc[:, 1], c=kmeans_etiquetas, cmap="viridis", s=60)
...
#Ahora si intentemos aplicar el algoritmo de aglomeramiento.
kmeans.fit(matriz_pca)
matriz_pca_kmeans_etiquetas = kmeans.labels_
print("Etiquetas :\n{}".format(matriz_pca_kmeans_etiquetas))
print("Dimensiones :\n{}".format(matriz_pca_kmeans_etiquetas.shape))
#Unir el vector de clasificacion con la matriz de datos.
#primeo hay que covertir el vector a dataframe.
matriz_pca_kmeans_etiquetas_ = pd.DataFrame( matriz_pca_kmeans_etiquetas, columns= ["Categorias"])
matriz_pca_kmeans = pd.merge(matriz_pca, matriz_pca_kmeans_etiquetas_, left_index= True, right_index= True, how = "inner")
print("\nMatriz con las categorias asignadas por kmeans: \n ", matriz_pca_kmeans.head(2) )
print("\nTipos de variables de la nueva matriz con las categorias de kmeans: \n ", matriz_pca_kmeans.info())


plt.scatter(matriz_pca_kmeans.iloc[:, 0], matriz_pca_kmeans.iloc[:, 1], c=matriz_pca_kmeans_etiquetas, cmap="viridis", s=60)
plt.xlabel("Primer componente")
plt.ylabel("Segundo componente")
plt.show()

#Exportar los datos.
matriz_pca_kmeans.to_csv("matriz_pca_kmeans.csv")
"""
...
#Ahora si intentemos aplicar el algoritmo de aglomeramiento.
kmeans.fit(matriz_pca_escalar)
matriz_pca_kmeans_escalar_etiquetas = kmeans.labels_
print("Etiquetas :\n{}".format(matriz_pca_kmeans_escalar_etiquetas))
print("Dimensiones :\n{}".format(matriz_pca_kmeans_escalar_etiquetas.shape))
#Unir el vector de clasificacion con la matriz de datos.
#primeo hay que covertir el vector a dataframe.
matriz_pca_kmeans_escalar_etiquetas_ = pd.DataFrame( matriz_pca_kmeans_escalar_etiquetas, columns= ["Categorias"])
matriz_pca_escalar_kmeans = pd.merge(matriz_pca_escalar, matriz_pca_kmeans_escalar_etiquetas_, left_index= True, right_index= True, how = "inner")
print("\nMatriz con las categorias asignadas por kmeans: \n ", matriz_pca_escalar_kmeans.head(2) )
print("\nTipos de variables de la nueva matriz con las categorias de kmeans: \n ", matriz_pca_escalar_kmeans.info())

plt.scatter(matriz_pca_escalar_kmeans.iloc[:, 0], matriz_pca_escalar_kmeans.iloc[:, 1], c=matriz_pca_kmeans_escalar_etiquetas, cmap="viridis", s=60)
plt.xlabel("Primer componente")
plt.ylabel("Segundo componente")
plt.show()

#Exportar los datos.
matriz_pca_escalar_kmeans.to_csv("matriz_pca_escalar_kmeans.csv")
"""
...
#primeo hay que covertir el vector a dataframe.
matriz_pca_kmeans_escalar_etiquetas_ = pd.DataFrame( matriz_pca_kmeans_escalar_etiquetas, columns= ["Categorias"])
matriz_pca_escalar_kmeans_outliers = pd.merge(matriz_pca_escalar, matriz_pca_kmeans_escalar_etiquetas_, left_index= True, right_index= True, how = "inner")
print("\nMatriz con las categorias asignadas por kmeans: \n ", matriz_pca_escalar_kmeans_outliers.head(2) )
print("\nTipos de variables de la nueva matriz con las categorias de kmeans: \n ", matriz_pca_escalar_kmeans_outliers.info())

#Visualizar los datos.
plt.scatter(matriz_pca_escalar_kmeans_outliers.iloc[:, 0], matriz_pca_escalar_kmeans_outliers.iloc[:, 1], c=matriz_pca_kmeans_escalar_etiquetas, cmap="viridis", s=60)
plt.xlabel("Primer componente")
plt.ylabel("Segundo componente")
plt.show()

#Exportar los datos.
matriz_pca_escalar_kmeans_outliers.to_csv("matriz_pca_escalar_kmeans_outliers.csv")
